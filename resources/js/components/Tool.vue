<template>
    <div>
        <heading class="mb-6">Laravel Schedule Monitor Nova</heading>
        ...
        >
            ...
            <p class="text-white-50% text-lg">
                ...
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">
                    /nova-components/LaravelScheduleMonitorNova/resources/js/components/Tool.vue
                </code>
            </p>
        </card>
    </div>
...
export default {
    metaInfo() {
        return {
          title: 'LaravelScheduleMonitorNova',
        }
    },
    mounted() {
        //
